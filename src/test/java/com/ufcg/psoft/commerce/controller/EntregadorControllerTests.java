...
public class EntregadorControllerTests {
    ...
    class EntregadorDefinirDisponibilidade {
        ...
        void quandoAlteramosDisponibilidadeParaDisponivel() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(patch(URI_ENTREGADORES + "/" + entregador.getId() + "/disponibilizarEntregador")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("codigoAcesso", entregador.getCodigoAcesso())
                            .content(objectMapper.writeValueAsString(entregadorPostPutRequestDTO)))
                    .andExpect(status().isOk())
        ...
        void quandoAlteramosDisponibilidadeParaIndisponivel() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(patch(URI_ENTREGADORES + "/" + entregador.getId() + "/indisponibilizarEntregador")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("codigoAcesso", entregador.getCodigoAcesso())
                            .content(objectMapper.writeValueAsString(entregadorPostPutRequestDTO)))
                    .andExpect(status().isOk())
        ...
        @Test
        @DisplayName("Quando alteramos a disponibilidade de um entregador inexistente para true")
        void quandoAlteramosDisponibilidadeDeEntregadorInexistenteParaTrue() throws Exception {
            // Arrange

            // Act
            String responseJsonString = driver.perform(patch(URI_ENTREGADORES + "/" + 999999 + "/disponibilizarEntregador")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("codigoAcesso", entregador.getCodigoAcesso())
                            .content(objectMapper.writeValueAsString(entregadorPostPutRequestDTO)))
                    .andExpect(status().isBadRequest())
        ...
        @Test
        @DisplayName("Quando alteramos a disponibilidade de um entregador inexistente para false")
        void quandoAlteramosDisponibilidadeDeEntregadorInexistenteParaFalse() throws Exception {
            // Arrange

            // Act
            String responseJsonString = driver.perform(patch(URI_ENTREGADORES + "/" + 999999 + "/indisponibilizarEntregador")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("codigoAcesso", entregador.getCodigoAcesso())
                            .content(objectMapper.writeValueAsString(entregadorPostPutRequestDTO)))
                    .andExpect(status().isBadRequest())
        ...
        @Test
        @DisplayName("Quando alteramos a disponibilidade de um entregador para true passando codigo de acesso inválido")
        void quandoAlteramosDisponibilidadeDeEntregadorComCodigoAcessoInvalidoParaTrue() throws Exception {
            // Arrange
        ...
        @Test
        @DisplayName("Quando alteramos a disponibilidade de um entregador para false passando codigo de acesso inválido")
        void quandoAlteramosDisponibilidadeDeEntregadorComCodigoAcessoInvalidoParaFalse() throws Exception {
            // Arrange
